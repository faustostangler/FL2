...
LANGUAGE = "pt-br"
COMPANY_ENDPOINT = {
    "initial": "https://stock.example.com/"
    "listedCompaniesProxy/CompanyCall/GetInitialCompanies/",
    "detail": "https://stock.example.com/listedCompaniesProxy/CompanyCall/GetDetail/",
    "financial": "https://stock.example.com/"
...
class ExchangeApiConfig:
    ...
    Attributes:
        ...
        company_endpoint: Mapping of logical names to exchange URLs.
    """

    language: str = field(default=LANGUAGE)
    company_endpoint: Mapping[str, str] = field(
